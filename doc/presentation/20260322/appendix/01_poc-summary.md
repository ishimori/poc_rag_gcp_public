...
> **注意**: 独自RAGの85.1%は、評価パイプライン自体のバグ（権限フィルタが全評価で無効だった等）の修正過程で計測された値であり、完全にクリーンな条件での計測ではない。詳細は[技術評価](02_technology-evaluation.md)の「計測上の注意」を参照。
...
→ 全12パターンの詳細は [技術評価](02_technology-evaluation.md) を参照
...
→ [詳細: 技術評価](02_technology-evaluation.md)
...
→ [詳細: Vertex AI Search 比較](03_vertex-comparison.md)
...
→ [詳細: 知見と提言](04_findings.md) | [今後のロードマップ](05_next-steps.md) | [申し送り](06_lessons-learned.md) | [画面キャプチャ](07_screenshots.md)
